...
<xsl:template match="/rss">
   ...
   <link rel="stylesheet" type="text/css" href="/~motorsports/assets/css/styles_feeling_responsive.css">
	...
	<link rel="canonical" href="http://localhost:4000/~motorsports/assets/xslt/rss.xslt">


	<!-- Facebook Open Graph -->
	<meta property="og:title" content="RSS Feed (Styled)">
	<meta property="og:description" content="Baja SAE Team at Stony Brook University">
	<meta property="og:url" content="http://localhost:4000/~motorsports/assets/xslt/rss.xslt">
